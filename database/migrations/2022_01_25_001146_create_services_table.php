...
class CreateServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->char('external_budget_id')->references('id')->on('budgets')->onDelete('cascade')->nullable();
            $table->char('external_route_id')->references('id')->on('external_routes')->onDelete('cascade')->nullable();
            ...
            $table->char('status');
            $table->char('estatus_info')->nullable();
            ...
            $table->integer('province_id')->references('id')->on('provinces')->onDelete('cascade')->nullable();
